...
public abstract class TestConf implements Source {

    private static final Logger LOG = LoggerFactory.getLogger(TestConf.class);
    private static final Validator VALIDATOR = (Validator) Validation.buildDefaultValidatorFactory().getValidator();
    ...
    private static TestConf buildTestConfSingleton(Config config) {
        ...
        Set<ConstraintViolation<TestConf>> constraintViolations = null;
        //constraintViolations = VALIDATOR.validate(testConf);
